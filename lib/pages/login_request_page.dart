...
import 'package:tudespensa/pages/login_verify_page.dart'; // pagina a la que se navega
import 'package:tudespensa/constants.dart'; // Colores
import 'package:tudespensa/widgets/auth/auth_banner.dart'; // Banner widget
import 'package:tudespensa/widgets/auth/auth_botton.dart'; // Widget del Botón
                      ...
                      AuthButton(
                        ...
                        onPressed: () async {
                          final success = await authProvider
                              .requestLoginCode(emailController.text.trim());
                          if (success) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
